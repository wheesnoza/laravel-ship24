...
class RateLimitContextTest extends TestCase
{
    ...
    public function test_falls_back_to_x_ratelimit_headers(): void
    {
        $response = new Response(new PsrResponse(200, [
        ...
        $this->assertSame(100, $context->limit());
        $this->assertSame(40, $context->remaining());
        $this->assertSame(9, $context->resetSeconds());
        $this->assertSame('x-ratelimit', $context->headerSource());
    }
    ...
    public function test_exposes_raw_headers(): void
    {
        $response = new Response(new PsrResponse(200, [
            'RateLimit-Limit' => ['200'],
            'X-Custom-RateLimit' => ['value'],
        ]));

        $context = RateLimitContext::fromResponse($response);

        $this->assertArrayHasKey('x-custom-ratelimit', $context->rawHeaders());
    }
